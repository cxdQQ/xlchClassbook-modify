						...
						<form class="form-horizontal" method="post" action="<?=U('Admin','WebConfig','Save')?>">
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane animated fadeInRight" id="MusicInfo">
										...
										<div class="col-sm-10">
											...
											<div class="radio">
												<label class="radio">
													...
													<i class="input-helper"></i>网易云api (wyyapi.cxdqq.top)
												</label>
											</div>
											<div class="radio">
												<label>
													<input type="radio" <?=($WebConfig['Music']['Player'] == 2 ? 'checked' : '')?> name="Music_Player" value="2">
													<i class="input-helper"></i>网易云音乐官方播放器
												</label>
											</div>
										</div>
									</div>
									...
									<script>
									$(function(){
										$('input[name="Music_Player"][value=0]').click(function(){$('#Music_Player_2').hide();});
										$('input[name="Music_Player"][value=1]').click(function(){$('#Music_Player_2').hide();});
										$('input[name="Music_Player"][value=2]').click(function(){$('#Music_Player_2').show();});
									});
									</script>-->
									<p>这里并没有什么用，音乐播放器不知道怎么在这里添加只能默认开启了，没有音乐时播放器会自动隐藏</p>
									<p>cookie请在\Template\Default\_Common\MusicConfig.php中配置</p>
								</div>
								<div role="tabpanel" class="tab-pane animated fadeInRight" id="FuckRobot">
									...
									<div class="form-group">
										<label for="FuckRobot_Image_Dir" class="col-sm-2 control-label">每1天最多可创建相册数</label>
										<div class="col-sm-10">
											<div class="fg-line">
									...
									<div class="form-group">
										<label for="FuckRobot_Image_Pic" class="col-sm-2 control-label">每1小时最多上传照片数</label>
										<div class="col-sm-10">
											<div class="fg-line">
									...
									<div class="form-group">
										<label for="FuckRobot_Image_Size" class="col-sm-2 control-label">照片最大上传大小(单位KB,1024KB = 1MB)</label>
										<div class="col-sm-10">
											<div class="fg-line">
