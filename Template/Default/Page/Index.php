<?php if(!defined("AdminPHP")) exit('<h1 style="color:red">Bad Reuest!</h1> <hr /> Powered By Xlch-AdminPHP');
?>
<style>
                                    ...
                                    <div class="pmbb-edit">
										<form action="" method="post" id="Group_<?=$Group['GroupId']?>">
											...
											$(function(){
												...
												var IsLoad_Group_<?=$Group['GroupId']?>=false;
